...
CREATE TABLE IF NOT EXISTS questions (
    ...
    correct_answer INT NULL COMMENT 'Index de la bonne réponse pour les QCM',
...
-- TABLE: responses (Réponses aux quiz)

CREATE TABLE IF NOT EXISTS responses (
    id INT AUTO_INCREMENT PRIMARY KEY,
    quiz_id INT NOT NULL,
    user_id INT NOT NULL,
    score DECIMAL(5,2) NULL COMMENT 'Score en pourcentage pour les quiz d ecole',
...
CREATE TABLE IF NOT EXISTS response_answers (
    ...
    question_id INT NOT NULL,
    answer_value TEXT NOT NULL COMMENT 'Index de l option choisie (QCM) ou texte libre',
